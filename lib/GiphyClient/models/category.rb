...
module GiphyClient
  ...
  class Category
    ...
    def self.swagger_types
      {
        :'name' => :'String',
        :'name_encoded' => :'String',
        :'subcategories' => :'Array<ShallowTag>',
        :'gif' => :'Gif'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'name_encoded')
        self.name_encoded = attributes[:'name_encoded']
      end
    ...
    def hash
      [name, name_encoded, subcategories, gif].hash
    end
